class WelcomeController < ApplicationController
  ...
  def get_product_hash
    ...
    hash["サラダチキン"]["ファミマ"]= Product_dto.new("ファミマ","チキン","サラダチキン","国産鶏のサラダチキン",239,113,120,20.8,1.5,2.9,"-","-",836)
    ...
    hash["サラダ"]["セブン"]= Product_dto.new("セブン","サラダ","サラダ","ミックス野菜サラダ(ドレッシング別売り）",163,nil,nil,nil,nil,nil,nil,nil,nil)
    hash["サラダ"]["ローソン"]= Product_dto.new("ローソン","サラダ","サラダ","コーンサラダ(ドレッシング別売り）",148,40,nil,nil,nil,5.6,nil,nil,nil) 
    hash["スープ"]["ファミマ"]= Product_dto.new("ファミマ","スープ","スープ","10種具材の豚汁",330,122,"nil",9.3,5.8,8.1,"nil","nol",1.2)
